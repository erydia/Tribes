document.addEventListener('DOMContentLoaded', () => {
    ...
    let setConstructionTimer = false;
    ...
    // Wybuduj budynek.
    const constructionBuilding = (object) => {
    ...
    const constructionOfTheBuilding = (constructionTime,  value) => {
    ...
    const victory = () => {
        ...
        // Pobieranie elementu reprezentującego wynik z drzewa DOM. 
        const newBuildingEls = document.querySelectorAll('.new-building');     
